...
void stack_init(stack_t *stk, const size_t size, const size_t elem_nmemb, FILE* log_file_ptr, stk_err *return_err, const char born_file[]="", const int born_line=0, const char born_func[]="");
